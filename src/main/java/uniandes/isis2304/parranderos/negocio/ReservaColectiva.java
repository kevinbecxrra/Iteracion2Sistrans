...
public class ReservaColectiva implements VOReservaColectiva,Comparable<ReservaColectiva> {
	 ...
	 */
	public ReservaColectiva(long id, long id_contrato, int personas, String fehca_inicio, String fecha_fin,
	...
	public String toString() {
		return "ReservaColectiva [id=" + id + ", id_contrato=" + id_contrato + ", personas=" + personas + ", fecha_inicio="
	...
	@Override
	public int compareTo(ReservaColectiva o) {
